...
@Injectable()
export class DispatcherPendingRequestService {
  ...
  createPendingRequest(
    ...
    const expiresAtMs = createdAtMs + DispatcherPendingRequestService.REQUEST_TIMEOUT_MS;
    ...
    }, DispatcherPendingRequestService.REQUEST_TIMEOUT_MS);
  ...
  private expireRequest(requestId: string) {
    ...
    this.expiredTombstones.set(
      requestId,
      Date.now() + DispatcherPendingRequestService.EXPIRED_TOMBSTONE_TTL_MS
    );
