...
export type NewAmbulance = InferInsertModel<typeof ambulance>;
...
export type Helpline = InferSelectModel<typeof helplines>;
export type NewHelpline = InferInsertModel<typeof helplines>;
...
export const bookings = pgTable(
  "bookings",
  {
    ...
    emtId: uuid("emt_id").references(() => users.id, {
      onDelete: "set null",
      onUpdate: "cascade",
    }),
  ...
  (t) => ({
    patientStatusIdx: index("patient_status_idx").on(t.patientId, t.status),
