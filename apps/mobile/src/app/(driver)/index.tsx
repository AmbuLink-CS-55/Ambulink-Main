  ...
  const handleCall = (phone?: string) => {
    ...
    const handleOpenOnMap = () => {
      ...
      if (rideStatus === "assigned") {
        url = `https://www.google.com/maps/dir/?api=1&destination=${currentRide.patient.lat},${currentRide.patient.lng}`;
      } else if (rideStatus === "arrived") {
        url = `https://www.google.com/maps/dir/?api=1&origin=${currentRide.patient.lat},${currentRide.patient.lng}&destination=${currentRide.hospital.lat},${currentRide.hospital.lng}`;
      }
