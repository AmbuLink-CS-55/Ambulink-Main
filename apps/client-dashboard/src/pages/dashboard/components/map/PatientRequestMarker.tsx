  ...
  return (
    <MapMarker longitude={coordinates[0]} latitude={coordinates[1]}>
      <MarkerContent className="relative flex items-center justify-center h-3 w-3">
        <span className="absolute h-20 w-20 rounded-full border border-[color:var(--secondary)] animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite]" />
        <span className="absolute h-15 w-15 rounded-full border border-[color:var(--secondary)] animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite] [animation-delay:0.3s]" />
        <span className="absolute h-10 w-10 rounded-full border border-[color:var(--secondary)] animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite] [animation-delay:0.6s]" />
